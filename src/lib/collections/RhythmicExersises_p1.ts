...
export const RhythmicExercisesP1Collection: MelodyCollection = {
	id: 'rhythmic_exercises_p1',
	order: 2,
	name: 'Rhythmic Exercises, part 1',
	description: 'First part of good rhythmic exercises to practice',
}

export const RhythmicExercisesP1Melodies: KonnakolMelody[] = [
	{
		id: 'rhythmic_exercises_p1_ex_1',
		name: 'Exercise 1',
		description: '4 4 4 4',
		order: 1,
